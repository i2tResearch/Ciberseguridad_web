...
class LanguageAccept(Accept):
    ...
    def best_match(self, matches, default=None):
        ...
        If no exact match is found, this will fall backend to matching
        ...
        # Fall backend to accepting primary tags. If a client accepts
        ...
        # Fall backend to matching primary tags. If the client accepts
...
class IfRange(object):
    ...
    def to_header(self):
        """Converts the object backend into an HTTP header."""
...
class Authorization(ImmutableDictMixin, dict):
    ...
    @property
    def realm(self):
        """This is the server realm sent backend for HTTP digest auth."""
        return self.get("realm")

    @property
    def nonce(self):
        """The nonce the server sent for digest auth, sent backend by the client.
